...
$this->registerJs(<<<js
    $('#create-chapter-title').val('$chapter_title');
...
//\yii\helpers\VarDumper::dump($session->get('modify.create-chapter.section_position'));
...
<section>
    ...
    <div class="metadata-item direct-to-session">
        <label for="create-chapter-title" class="header3 metadata-item-title">
            <div>Название <span class="required-symbol">*</span></div>
            <!--<span class="content-limit tip-color">150</span>-->
        </label>
        <div class="ui field"><input type="text" name="create-chapter-title" id="create-chapter-title" placeholder="Название части" maxlength="150"></div>
    ...
    <div class="metadata-item">
        ...
        <!--<div class="head-article" style="margin: 0 0 14px">Допускаются файлы форматов <b>.odt</b> и <b>.docx</b>.</div>-->
        <div class="ui field">
            <select name="create-chapter-section_position" id="create-chapter-section_position">
    ...
    <div class="metadata-item">
        ...
        <!--<div class="head-article" style="margin: 0 0 14px">Допускаются файлы форматов <b>.odt</b> и <b>.docx</b>.</div>-->
        <div class="ui field">
            <select name="create-chapter-chapter_position" id="create-chapter-chapter_position">
