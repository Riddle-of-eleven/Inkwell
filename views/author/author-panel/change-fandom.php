...
?>
    ...
    <div class="header1">Изменение фэндома</div>
...
<?= $f->field($fandom, 'description')->textarea(['rows' => '6', 'placeholder' => 'Вкратце расскажите о вашем фэндоме']) ?>
